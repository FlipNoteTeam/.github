...
| 즐겨찾기 및 좋아요 | 
|:---:|
| ![즐겨찾기](./images/cardset-detail-like.png) |
...
|:---:|:---:|
| ![암기모드1](./images/memo-mode-1.png) | ![암기모드2](./images/memo-mode-2.png) |

#### 시험 모드

| 시험 모드 화면 1 | 시험 모드 화면 2 | 시험 모드 화면 3 |
|:---:|:---:| :---: |
| ![시험모드1](./images/test-mode-1.png) | ![시험모드2](./images/test-mode-2.png) | ![시험모드3](./images/test-mode-3.png)|
...
| 그룹 조회 | 그룹 가입 | 그룹 권한 관리 |
|:---:|:---:|:---:|
| ![그룹조회](./images/group-list.png) |  ![그룹가입](.images/group-join.png)| ![그룹권한관리](./images/role-management.png) |
...
|:---:|:---:|:---:|
| ![카드셋조회1](./images/cardset-list.png) | ![카드셋조회2](./images/cardset-detail.png) | ![카드셋조회3](./images/cardset-manage.png) |
...
|:---:|:---:|:---:|
| ![마이페이지1](./images/mypage.png) | ![마이페이지2](./images/mypage-2.png) | ![마이페이지3](./images/mypage-3.png) |

| 마이페이지 4 |
|:---:|
| ![마이페이지4](./images/mypage-4.png) | 
...
| **메시지 큐** | RabbitMQ |
| **스토리지** | AWS S3 |
| **컨테이너 오케스트레이션** | Kubernetes (K8S), Helm |
